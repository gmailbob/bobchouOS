...
/* ---- Device status bits (OR'd into STATUS during the handshake) ----
 * Listed in handshake order. See Lecture 7-1, Part 3. */
#define VIRTIO_STATUS_ACKNOWLEDGE (1 << 0) /* "I see you" */
#define VIRTIO_STATUS_DRIVER      (1 << 1) /* "I know how to drive you" */
#define VIRTIO_STATUS_FEATURES_OK (1 << 3) /* "We agree on features" */
#define VIRTIO_STATUS_DRIVER_OK   (1 << 2) /* "I'm ready, go" */

/* ---- Descriptor flags (OR'd into desc.flags) ---- */
